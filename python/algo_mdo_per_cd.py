...
#
# algo_mdo_per_cd.py - Prisoner's Dilemma tournament algorithm file
#
# The algo_mdo_per_cd algorithm behaves as follows:
#    if the modulo w.r.t 2 of the number of moves is
#        0: return choices.COOPERATE
#        1: return choices.DEFECT
#
...
#
def algo_mdo_per_cd(selfHist, oppHist, ID):
    if 1 == (len(oppHist) % 2):
...
if __name__ == "__main__":
    sys.stderr.write("ERROR - algo_mdo_per_cd.py is not intended to be run stand-alone\n")
    exit(-1)
