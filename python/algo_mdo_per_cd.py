...
#
# algo_per_cd.py - Prisoner's Dilemma tournament algorithm file
#
# The algo_per_cd algorithm behaves as follows:
...
#
def algo_per_cd(selfHist, oppHist):
    if 1 == (len(oppHist) % 2):
...
if __name__ == "__main__":
    sys.stderr.write("ERROR - algo_per_cd.py is not intended to be run stand-alone\n")
    exit(-1)
