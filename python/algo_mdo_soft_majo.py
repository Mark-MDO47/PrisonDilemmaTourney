...
#
# algo_mdo_soft_majo.py - Prisoner's Dilemma tournament algorithm file
#
# The algo_mdo_soft_majo algorithm behaves as follows:
#    On the first move it returns choices.COOPERATE
#    After that:
#        if the opponent choices.COOPERATE >= choices.DEFECT, return choices.COOPERATE
...
def algo_mdo_soft_majo(selfHist, oppHist):
