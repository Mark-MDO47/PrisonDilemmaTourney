...
#
# algo_mdo_hard_majo.py - Prisoner's Dilemma tournament algorithm file
#
# The algo_mdo_hard_majo algorithm behaves as follows:
#    On the first move it returns choices.DEFECT
#    After that:
#        if the opponent choices.COOPERATE > choices.DEFECT (not >=), return choices.COOPERATE
#        else return choices.DEFECT
#
...
def algo_mdo_hard_majo(selfHist, oppHist):
