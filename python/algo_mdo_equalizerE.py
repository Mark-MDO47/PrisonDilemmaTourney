...
#
# algo_mdo_equalizerE.py a Prisoner's Dilemma algorithm.
#
...
p_d_c = 2.0/3.0
p_d_d = 1.0/3.0
def algo_mdo_equalizerE(selfHist, oppHist, ID):
    return prob.probabilistic_strategy(selfHist, oppHist, ID, p_c_c, p_c_d, p_d_c, p_d_d)

if __name__ == "__main__":
    sys.stderr.write("ERROR - algo_mdo_equalizerE.py is not intended to be run stand-alone\n")
    exit(-1)
