...
#
# algo_mdo_extortionD.py a Prisoner's Dilemma algorithm.
#
...
p_d_c = 0.50
p_d_d = 0.00
def algo_mdo_extortionD(selfHist, oppHist, ID):
    return prob.probabilistic_strategy(selfHist, oppHist, ID, p_c_c, p_c_d, p_d_c, p_d_d)

if __name__ == "__main__":
    sys.stderr.write("ERROR - algo_mdo_extortionD.py is not intended to be run stand-alone\n")
    exit(-1)
