...
Here are some example results of evolution using different Rewards:
- Classic Range: D_C=0, C_C=1, D_D=3, C_D=5
- Extended Range: D_C=0, C_C=1, D_D=5, C_D=10

The numbers in each row represent the number of instances of that algorithm "surviving" at the end of 30 evolutions under the conditions shown. It is easily seen that the results are quite sensitive to rewards and to the percentage of mistakes per move.

 <br>
 
 ### Classic Range
 ![alt text](https://github.com/Mark-MDO47/PrisonDilemmaTourney/blob/main/Evolve_ClassicRange.png "Evolution Classic Range Results")

 <br>
 
 ### Extended Range
![alt text](https://github.com/Mark-MDO47/PrisonDilemmaTourney/blob/main/Evolve_ExtendRange.png "Evolution Extended Range Results")
